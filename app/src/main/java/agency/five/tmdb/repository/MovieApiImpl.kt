...
class MovieApiImpl : MovieApi {
    ...
    override suspend fun getAllMovies(): MovieResponse {
        return MovieResponse(movies = allMovies, null, null)
    }

    override suspend fun getAllCategories(): MovieResponse {
        return MovieResponse(null, categories = categories, null)
    }

    override suspend fun getMovieByID(id: Long): MovieResponse {
        return MovieResponse(null, null, allMovies.filter { movie -> movie.id == id }.firstOrNull())
    }
}
